            ...
            <div class="media simple-post" v-for="post in posts" :key="post.id" >
                ...
                <div class="media-body">
                    ...
                    <ul class="list-inline list-unstyled d-flex post-info">
                        <li v-if="post.user"><span><i class="fa fa-user"></i> posted by : <strong class="text-primary">  {{post.user.name}}  </strong> </span></li>
                        <li>|</li>
...
<!----
    ...
    methods:{
        getCategoryPosts(){
            axios.get("/api/category/" + this.$route.params.slug )     // start link( (/) -> to start link from begianing) 
